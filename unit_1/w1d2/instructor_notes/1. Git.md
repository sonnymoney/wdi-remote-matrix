...
Pull any changes made to the repo into your local version of the repo
...
1. Add original remote repo with `git remote upstream https://github.com/mahuntington/asdfasdf.git`
	- `upstream` is a conventional name, it be anything, though
